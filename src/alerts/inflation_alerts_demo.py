...
from src.alerts.inflation_alerts import inflation_spike_alerts
...
def run_demo():
    ...
    inflation_rows = week_over_week_inflation(avgs)

    alerts = inflation_spike_alerts(inflation_rows, spike_pct=5.0)
    print("\n".join(alerts) if alerts else "No inflation spikes.")
